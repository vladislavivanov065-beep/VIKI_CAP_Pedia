...
одно самое релевантное по смыслу предложение по всем статьям и
возвращают его как есть — не пересказ, а точная цитата того места в
статьях, которое максимально похоже на вопрос. Генеративная модель
здесь не используется: маленькие локальные модели либо копировали
